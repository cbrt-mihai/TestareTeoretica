...
public class LCSAJCoverage {
    ...
    @Test
    void t6Test(){
        // t6 covers LCSAJ 7, 10, 12, 13, 14, 15, 18, 19, 21, 22, 23
        try {
    ...
    @Test
    void t7Test(){
        // t7 covers LCSAJ 8, 10, 15, 19, 21, 22, 23
        try {
            expectedList = new ArrayList<>(List.of(5));
    ...
    @Test
    void t8Test(){
        // t8 covers LCSAJ 9, 10, 15, 16, 17, 19, 20, 21, 22, 23
        try {
            expectedList = new ArrayList<>();
